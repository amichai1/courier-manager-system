...
public class Order
{
    ...
    public override string ToString()
    {
        return $"""
            ...
            Aerial Distance:         {AerialDistance} km
            ...
            Expected Delivery Time:  {ExpectedDeliveryTime:yyyy-MM-dd HH:mm:ss}
            ...
            Completion Time:         {(OrderCompletionTime.HasValue ? $"{OrderCompletionTime.Value.TotalHours:F2} hours" : "[Not completed]")}
